<!-- GFM-TOC -->
* [1. Cyclic Sort (easy)](#1-有序数组的-two-sum)
* [2. Find the Missing Number (easy)](#2-两数平方和)
* [3. Find all Missing Numbers (easy)](#3-反转字符串中的元音字符)
* [4. Find the Duplicate Number (easy)](#4-回文字符串)
* [5. Find all Duplicate Numbers (easy)](#5-归并两个有序数组)
<!-- GFM-TOC -->
