<!-- GFM-TOC -->
* [1. Merge K Sorted Lists (medium)](#1-有序数组的-two-sum)
* [2. Kth Smallest Number in M Sorted Lists (Medium)](#2-两数平方和)
* [3. Kth Smallest Number in a Sorted Matrix (Hard)](#3-反转字符串中的元音字符)
* [4. Smallest Number Range (Hard)](#4-回文字符串)
<!-- GFM-TOC -->
