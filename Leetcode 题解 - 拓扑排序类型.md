<!-- GFM-TOC -->
* [1. Topological Sort (medium)](#1-有序数组的-two-sum)
* [2. Tasks Scheduling (medium)](#2-两数平方和)
* [3. Tasks Scheduling Order (medium)](#3-反转字符串中的元音字符)
* [4. All Tasks Scheduling Orders (hard)](#4-回文字符串)
* [5. Alien Dictionary (hard)](#5-归并两个有序数组)
<!-- GFM-TOC -->
